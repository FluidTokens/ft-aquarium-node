...
import static com.fluidtokens.aquarium.offchain.MainnetTestConstants.*;

@Slf4j
public class MainnetStakingTest {

    private final ObjectMapper objectMapper = new ObjectMapper();

    private final String blockfrostMainnetKey = System.getenv("BLOCKFROST_KEY");

    private final String mainnetMnemonic = System.getenv("WALLET_MNEMONIC");
    ...
    private final BFBackendService bfBackendService = new BFBackendService(Constants.BLOCKFROST_MAINNET_URL, blockfrostMainnetKey);
    ...
    public void fetchParameters() throws Exception {
        ...
        var parametersUtxo = bfBackendService
                .getUtxoService()
        ...
        log.info("parameters.getMinAda: {}", parameters.getMinAda());
    ...
    public void stake() throws Exception {
        ...
        var adminAccount = new Account(network, mainnetMnemonic);
        ...
        var stake = Value.builder()
                .multiAssets(List.of(
                        MultiAsset.builder()
                                .policyId(FT_TOKEN_POLICY_ID)
                                .assets(List.of(Asset.builder()
                                        .name("0x" + FT_TOKEN_ASSET_NAME)
                                        .value(parameters.getMinToStake())
                                        .build()))
                                .build()
                ))
                .build();
